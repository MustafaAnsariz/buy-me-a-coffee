  ...
  return (
    <div className="text-white container mx-auto pt-12 pb-18">
      <h1 className="font-black text-center text-3xl">
        {" "}
        Login to get your fans to support them{" "}
      </h1>

      <div className="loginbtns">
        <div className="flex flex-col items-center gap-2 min-h-screen p-10">
          <button className="flex items-center bg-slate-300 border  w-64 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-slate-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
          ...
          <button
            ...
            className="flex items-center bg-slate-300 border w-64 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-slate-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
