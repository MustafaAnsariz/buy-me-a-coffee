...
const Login = () => {
  ...
  return (
    <div className="text-white container mx-auto pt-16 pb-20 min-h-[calc(100vh-120px)] flex flex-col items-center justify-center"> {/* Adjusted padding and min-height */}
      <h1 className="font-black text-center text-4xl md:text-5xl mb-12">
        Join & Support Creators
      </h1>

      <div className="flex flex-col items-center gap-6 w-full"> {/* Increased gap for buttons */}
        {/* Google Login Button */}
        <button 
        ...
        >
          <svg
            className="h-6 w-6 mr-3" // Added more margin to the right of SVG
            xmlns="http://www.w3.org/2000/svg"
            viewBox="-0.5 0 48 48" // Kept original viewBox
          >
            {/* Google SVG paths from your original code */}
